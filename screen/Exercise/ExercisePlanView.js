  ...
  const headerHeight = 48;
	...
	return (
      ...
      <View style={styles.header}>	
        <Text numberOfLines={1} ellipsizeMode='tail' style={styles.headerTitle}>운동 계획</Text>
        <TouchableOpacity 
			...
			>
              ...
              <ImgDomain fileWidth={18} fileName={'popup_x.png'} />
						...
						<View style={[styles.popTitle]}>
							<Text style={styles.popTitleText}>운동 계획 삭제</Text>							
						</View>				
						<View>
							<Text style={[styles.popTitleDesc, styles.mgt0]}>운동 계획을 삭제하시겠습니까?</Text>						
						</View>
...
const styles = StyleSheet.create({
  ...
  logInfoLeft: {width:innerWidth-200},
  logInfoRight: {width:170,},

								...
								{file.path ? (
									<View style={styles.fileBox}>
										<View style={styles.fileBoxLeft}>										
											<AutoHeightImage width={36} source={{ uri: file.path }} style={styles.fileBoxLeftImg} />
						...
						<View style={styles.cmWrap}>
							...
							<View style={styles.mgt40}>
								...
								{jobFile.path ? (
									<View style={styles.fileBox}>
										<View style={styles.fileBoxLeft}>										
											<AutoHeightImage width={36} source={{ uri: jobFile.path }} style={styles.fileBoxLeftImg} />
											<View style={styles.fileBoxLeftInfo}>
								...
								<View style={styles.cmWrap}>
									...
									<View style={styles.mgt40}>
										...
										{schoolFile.path ? (
											<View style={styles.fileBox}>
												<View style={styles.fileBoxLeft}>										
													<AutoHeightImage width={36} source={{ uri: schoolFile.path }} style={styles.fileBoxLeftImg} />
													<View style={styles.fileBoxLeftInfo}>
								...
								<View style={styles.cmWrap}>
									...
									<View style={styles.mgt40}>
										...
										{marryFile.path ? (
											<View style={styles.fileBox}>
												<View style={styles.fileBoxLeft}>										
													<AutoHeightImage width={36} source={{ uri: marryFile.path }} style={styles.fileBoxLeftImg} />
													<View style={styles.fileBoxLeftInfo}>
...
const styles = StyleSheet.create({
  ...
  nextBtnOff: {backgroundColor:'#DBDBDB'},
	...
	fileBoxLeftImg: {borderWidth:1,borderColor:'#DBDBDB',borderRadius:5,},

              ...
              <View style={[styles.cmWrap, styles.pdb20]}>
                ...
                <View style={[styles.guideView, styles.mgt20]}>
                  <TouchableOpacity
                    ...
                    activeOpacity={opacityVal}
                    onPress={()=>{console.log('마이페이지 > 커뮤니티 이용 가이드 페이지 이동!');}}
                  >
...
const styles = StyleSheet.create({
  ...
  textarea: {width:innerWidth,minHeight:180,paddingVertical:0,paddingHorizontal:15,textAlignVertical:'top',fontFamily:Font.NotoSansRegular,fontSize:14,},
